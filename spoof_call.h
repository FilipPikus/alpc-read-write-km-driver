 ...
 * on the stack points to unmapped memory and can be detected by EAC stack walks.
 *
 ...
 *   4. Target returns to gadget, the gadget does add rsp,0x28; ret, then returns to us
 */
